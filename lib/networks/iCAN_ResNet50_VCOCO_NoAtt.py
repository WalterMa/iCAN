...
class ResNet50():
    ...
    def head_to_tail(self, fc7_H, fc7_O, sp, is_training, name):
        with slim.arg_scope(resnet_arg_scope(is_training=is_training)):
            ...
            Concat_SHsp = slim.fully_connected(sp, self.num_fc, scope='Concat_SHsp')
    ...
    def build_network(self, is_training):
        ...
        fc7_SH, fc7_SO, fc7_SHsp = self.head_to_tail(fc7_H, fc7_O, sp, is_training, 'fc_HO')
